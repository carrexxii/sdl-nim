...
{.push dynlib: SdlLib.}
proc sdl_vulkan_load_library*(path: cstring): bool                                             {. importc: "SDL_Vulkan_LoadLibrary"             .}
...
proc sdl_vulkan_create_surface*(win: Window; inst, alloc, surface: pointer): bool              {. importc: "SDL_Vulkan_CreateSurface"           .}
proc sdl_vulkan_destroy_surface*(inst, surface, alloc: pointer)                                {. importc: "SDL_Vulkan_DestroySurface"          .}
proc sdl_vulkan_get_presentation_support*(inst, phys_dev: pointer; q_family_idx: uint32): bool {. importc: "SDL_Vulkan_GetPresentationSupport"  .}
{.pop.}
